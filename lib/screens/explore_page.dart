                    ...
                    SizedBox(
                      ...
                      child: ListView(
                        ...
                        children: [
                          ...
                          _CategoryChip(
                            label: 'University',
                            category: PaperCategory.university,
                            selected:
                                _selectedCategory == PaperCategory.university,
                            onTap: () => setState(
                              () => _selectedCategory =
                                  _selectedCategory == PaperCategory.university
                                  ? null
                                  : PaperCategory.university,
                            ),
                          ),
                          const SizedBox(width: 8),
                          _CategoryChip(
                            label: 'High School',
                            category: PaperCategory.highSchool,
                            selected:
                                _selectedCategory == PaperCategory.highSchool,
                            onTap: () => setState(
                              () => _selectedCategory =
                                  _selectedCategory == PaperCategory.highSchool
                                  ? null
                                  : PaperCategory.highSchool,
                            ),
                          ),
                          const SizedBox(width: 8),
                          _CategoryChip(
                            label: 'Competitive',
                            category: PaperCategory.competitive,
                            selected:
                                _selectedCategory == PaperCategory.competitive,
                            onTap: () => setState(
                              () => _selectedCategory =
                                  _selectedCategory == PaperCategory.competitive
                                  ? null
                                  : PaperCategory.competitive,
                            ),
                          ),
                          const SizedBox(width: 8),
                          _CategoryChip(
                            label: 'Professional',
                            category: PaperCategory.professional,
                            selected:
                                _selectedCategory == PaperCategory.professional,
                            onTap: () => setState(
                              () => _selectedCategory =
                                  _selectedCategory ==
                                      PaperCategory.professional
                                  ? null
                                  : PaperCategory.professional,
                            ),
                          ),
                      ...
                      Row(
                        children: [
                          ...
                          _SortChip(
                            ...
                            value: 'downloads',
                            current: _sortBy,
                            onTap: () => setState(() => _sortBy = 'downloads'),
                          ),
                          const SizedBox(width: 8),
                          _SortChip(
                            label: 'Most Recent',
    ...
    return Padding(
      ...
      child: Column(
        children: [
          ...
          Text(
            hasQuery ? 'No papers matched your search' : 'No papers yet',
            style: GoogleFonts.manrope(
              fontSize: 16,
              fontWeight: FontWeight.w700,
              color: cs.onSurface,
          ...
          Text(
            hasQuery
                ? 'Try different keywords or clear the filter to browse all papers.'
                : 'Be the first to upload a paper and earn points!',
